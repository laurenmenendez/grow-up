...
This template contains a project, `grow_up`, and an app, `api`,
...
1. Replace all instances of `grow_up` with your application name. **This includes the folder included in this repository.**
...
This template includes a project `grow_up` which should be renamed
...
all instances of `grow_up` with your app's name.
