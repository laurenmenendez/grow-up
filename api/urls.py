...
urlpatterns = [
    ...
    path('children/<int:child_pk>/milestones/', Milestones.as_view(), name='milestones'),
    path('children/<int:child_pk>/milestones/<int:pk>/', MilestoneDetail.as_view(), name='milestone_detail'),
